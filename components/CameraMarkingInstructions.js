    ...
    return <div className="container">
        ...
        <section className="section">
            <div className="container">
                ...
                <h1 className="title">Part {this.props.stepNumber}: Mark the Camera</h1>
                ...
                <div className="columns is-vcentered">
                    ...
                    <div className="column">
                        ...
                        <div className="content">
                            ...
                            <p>
                                To get around that issue, I recommend squeezing in the masking/duct tape for this above the camera, instead of next to it. 
